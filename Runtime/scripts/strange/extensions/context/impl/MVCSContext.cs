...
namespace strange.extensions.context.impl
{
	public class MVCSContext : CrossContext
	{
		...
		public IMediationBinder _mediationBinder;
		public IMediationBinder mediationBinder{
			get => _mediationBinder;

			set
			{
				Debug.Log($"MediationBinder {_mediationBinder} => {value}");
				_mediationBinder = value;
			}
		}
		...
		{
			Debug.Assert(mediationBinder != null, $"Can not enable view {view}. The MediationBinder is NULL!");
